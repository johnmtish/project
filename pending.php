...
<?php
 ...
 $resultset= $conn -> query("SELECT * FROM bookings WHERE STATUS ='pending' ");

 if ($resultset -> num_rows !=0){

  while ($rows=$resultset -> fetch_assoc()){
echo "<form method =POST action =pennding.php>";
   ...
   echo "<td>"."<input type='submit' name='failed' value='fail/cancel'>" ." </td>";
